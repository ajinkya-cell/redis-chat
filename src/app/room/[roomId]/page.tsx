                    ...
                    <div key={msg.id} className="flex flex-col items-start">
                        <div className="max-w-[80%] group">
                            <div className="flex items-baseline gap-3 mb-1">
                                <span className={`text font-bold ${msg.sender === username ? 'text-green-500': "text-blue-500"}`}>
            ...
            <div className="flex gap-4">
                <div className="flex-1 relative group">
                    ...
                    <input type="text"
                     ...
                     onChange={(e) => setInput(e.target.value)} className="w-full bg-black border border-zinc-800 focus:border-zinc-700 focus:outline-none transition-colors text-zinc-100 placeholder:text-zinc-700 py-3 pl-8 pr-4 text-sm" />
                </div>
